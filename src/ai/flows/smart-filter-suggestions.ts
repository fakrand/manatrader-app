 ...
 *
 * - `smartFilterSuggestionsFlow` - A function that takes a search query and returns suggested filters.
 * - `SmartFilterSuggestionsInput` - The input type for the `smartFilterSuggestionsFlow` function.
 * - `SmartFilterSuggestionsOutput` - The return type for the `smartFilterSuggestionsFlow` function.
 */
